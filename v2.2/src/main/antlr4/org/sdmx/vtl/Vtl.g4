...
;
 ...
 anFunctionComponent:
   op = ( SUM
    ...
    | op=(LAG |LEAD)  LPAREN exprComponent (COMMA offset=signedInteger(COMMA defaultValue=scalarItem)?)?  OVER  LPAREN (partition=partitionByClause? orderBy=orderByClause)   RPAREN RPAREN   # lagOrLeadAnComponent
