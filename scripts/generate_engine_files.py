...
# FIXME version folder should be a script parameter (CLI or Python var)
OPERATORS_FOLDER = Path(__file__).parent.parent / "v2.1" / "docs" / "reference_manual" / "operators"
OUTPUT_FOLDER = Path(__file__).parent.parent / "v2.1" / "engine_files"
...
def generate_files_from_folder(folder: Path):
    ...
    operator_output_folder = (
        OUTPUT_FOLDER / folder.parent.parent.name / folder.parent.name
    )
