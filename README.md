...
The last official version of the language is [v2.0](https://github.com/amattioc/vtl/tree/master/v2.0) and it includes:
...
A new version ([v2.1](https://github.com/amattioc/vtl/tree/master/v2.1)) is currently being developed and the documentation is mainly html based and it si hosted in [github pages](https://amattioc.github.io/vtl/)
